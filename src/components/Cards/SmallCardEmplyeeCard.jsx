...
const SmallCardEmplyeeCard = () => {
  return (
    <Box sx={{ padding: "10px 18px 9px 10px" }}>
      <Card
        sx={{
          display: "flex",
          width: "224px",
...
export default SmallCardEmplyeeCard;
